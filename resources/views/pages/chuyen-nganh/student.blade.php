...
<div class="content">
    @if(isset($chuyenNganhs) && $chuyenNganhs->count())
        <div class="container">
            <div class="header">
                <h2 class="title">Danh sách chuyên ngành</h2>
            </div>
                ...
                <table class="score-table">
                    ...
                    @foreach($chuyenNganhs as $chuyenNganh)
                        <tr>
                            ...
                            <td>{{ $chuyenNganh->monHoc->sum('tin_chi') }}</td>
                            <td style="max-width: 400px; overflow-wrap: break-word; word-break: break-word;">
                                {{ $chuyenNganh->chuan_dau_ra }}
                            </td>

                            <td>
                                <a href="{{route('student.chuyen-nganh-by-mon-hoc', $chuyenNganh->id)}}"
                                   style="color: var(--primary-color); font-weight: 500; text-decoration: underline;">
                                    Xem chi tiết
                                </a>
                            </td>
                        </tr>
    ...
    @else
        <p>Chưa chọn ngành hoặc ngành này chưa có chuyên ngành.</p>
    @endif
