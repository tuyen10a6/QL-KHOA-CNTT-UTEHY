...
<body>
    ...
    <main class="content">
        <div class="container">
            ...
            <form action="{{ route('thong-tin-ca-nhan.cap-nhat') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <div class="avatar-container">
                    <div class="avatar-preview">
                        <img src="{{ $user->anh_dai_dien ? asset('storage/' . $user->anh_dai_dien) : asset('assets/images/default-avatar.png') }}" alt="Avatar">
                    </div>
                    <div class="avatar-upload">
                        <input type="file" name="anh_dai_dien" id="anh_dai_dien" accept="image/*">
                        <label for="anh_dai_dien">Chọn ảnh đại diện</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control @error('so_dien_thoai') is-invalid @enderror" id="so_dien_thoai" name="so_dien_thoai" value="{{ old('so_dien_thoai', $user->so_dien_thoai) }}">
                    @error('so_dien_thoai')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('dia_chi') is-invalid @enderror" id="dia_chi" name="dia_chi" rows="3">{{ old('dia_chi', $user->dia_chi) }}</textarea>
                    @error('dia_chi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
